...
public final class HeaderUtils
{
	 ...
	 * @param uc a connected URLConnection
	...
	public static Header extractHeaders(URLConnection uc)
	{
		...
		{
			Log.e("cookie", uc.getHeaderFieldKey(i)+","+uc.getHeaderField(i));
	 ...
	 * @param uc an un-connected URLConnection
	 * @param h a Header
	 */
	public static void setHeaders(URLConnection uc, Header h)
	{
		if(uc == null)
		{
			throw new IllegalArgumentException("Null URLConnection");
		...
		//System.out.println("HeaderUtils.setHeaders(): I've been asked to set the following Headers = " + h);
